	  				...
	  				<div class="lock-screen">
				          ...
				          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
				              <div class="modal-dialog">
                                <form method="POST" action="{{route('/lockscreenlogin')}}">
                                    {{ csrf_field() }}
				                  <div class="modal-content">
				                      ...
				                      <div class="modal-footer centered">
				                          ...
				                          <button onclick="testJS()" class="btn btn-theme03" type="submit">Login</button>
				                      </div>
				                  </div>
                              </form>
				              </div>
    ...
    function testJS()
          {
            ...
            var ID_String =  document.getElementById("password").value ;

            console.log(bcrypt(ID_String));
          }
</script>
